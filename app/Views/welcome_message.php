...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="Views/paginas/practicanding.php">Practicanding</a></li>
    ...
    <div class="heroe">
        ...
        <h1>Wena cigueña <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
